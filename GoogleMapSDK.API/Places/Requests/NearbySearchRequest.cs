...
{
    [Transient]
    internal class NearbySearchRequest : APlaceRequest<NearbySearchApiRequestModel, PlaceDetailApiResponseModel>
    {
        public NearbySearchRequest(HttpRequest httpRequest) : base(httpRequest)
        {
        }
        ...
        protected override string TotalUrl => $"{BASE_URL}searchNearby";
    }
}
