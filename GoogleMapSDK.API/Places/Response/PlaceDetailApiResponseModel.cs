...
{
    internal class PlaceDetailApiResponseModel : AResponseModelV2
    {
        ...
        public PlusCodeModel PlusCode { get; set; }
        ...
        public TextModel DisplayName { get; set; }
        public TextModel PrimaryTypeDisplayName { get; set; }
        ...
        public PlaceDetailModel GetPlaceDetail()
        {
            ...
            return new Mapper<PlaceDetailApiResponseModel, Contract.Models.PlaceDetailModel>().Map(this);
        }
